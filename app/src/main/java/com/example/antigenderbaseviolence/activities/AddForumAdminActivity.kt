...
import com.example.antigenderbaseviolence.databinding.ActivityAddForumAdminBinding
...
//view binding
private lateinit var binding: ActivityAddForumAdminBinding
...
class AddForumAdminActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAddForumAdminBinding.inflate(layoutInflater)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                ref.child("$timestamp")
                    ...
                    .addOnSuccessListener {
                        ...
                        startActivity(Intent(this@AddForumAdminActivity, ForumActivity::class.java))
                        finish()
                    }
