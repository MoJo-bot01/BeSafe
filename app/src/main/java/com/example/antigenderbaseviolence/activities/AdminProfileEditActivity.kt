...
import com.example.antigenderbaseviolence.databinding.ActivityAdminProfileEditBinding
...
private lateinit var binding: ActivityAdminProfileEditBinding
...
class AdminProfileEditActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAdminProfileEditBinding.inflate(layoutInflater)
        ...
        ref.child(auth.uid!!)
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    try {
                        Glide.with(this@AdminProfileEditActivity)
                            .load(profileImage)
